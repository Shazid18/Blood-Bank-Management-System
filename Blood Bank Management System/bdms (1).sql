...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2290789379ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=recipient">`bdms`.`recipient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=patient">`bdms`.`patient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+donor">`bdms`.`blood donor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+donation+event">`bdms`.`blood donation event`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+bank">`bdms`.`blood bank`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood">`bdms`.`blood`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+patient">`bdms`.`blood patient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood_donor">`bdms`.`blood_donor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=Blood_Donor">`bdms`.`Blood_Donor`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
    ...
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood bank">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood bank`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood donation event">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood donation event`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood donor">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood donor`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="patient">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
