...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3916074071ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=recipient">`bdms`.`recipient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood">`bdms`.`blood`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood_donor">`bdms`.`blood_donor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood_donation_event">`bdms`.`blood_donation_event`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood_bank">`bdms`.`blood_bank`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=hhhhh">`bdms`.`hhhhh`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+donation+event">`bdms`.`blood donation event`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+donor">`bdms`.`blood donor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=blood+bank">`bdms`.`blood bank`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bdms&table=patient">`bdms`.`patient`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2e6e752979587b367c723c2e7a5b5765">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="bdms" targettable="recipient">
            ...
            Queried time
                            ...
                            <span class="query">SELECT reci_address
FROM recipient
WHERE reci_id = &#039;10101001&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="recipient">
                            <div class="action_content">
...
WHERE reci_gender = &#039;Female&#039;;</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT reci_id
FROM recipient
WHERE reci_gender = &#039;Female&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood_donor">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT don_id
FROM blood_donor
WHERE don_gender = &#039;Female&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood_donor">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT don_address
FROM blood_donor
WHERE don_id = &#039;20101005&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="hhhhh">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `hhhhh`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="recipient">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `recipient`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="recipient">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `recipient`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood_bank">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood_bank`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood_donation_event">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood_donation_event`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="blood_donor">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood_donor`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bdms" targettable="recipient">
                            <div class="action_content">
